...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-easttestnet", "Use the east testnet chain. Equivalent to -chain=easttestnet.", ArgsManager::ALLOW_ANY, OptionsCategory::CHAINPARAMS);
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    ...
    case ChainType::EASTTESTNET:
        return std::make_unique<CBaseChainParams>("easttestnet", 18443, 18445);
    }
    assert(false);
}
