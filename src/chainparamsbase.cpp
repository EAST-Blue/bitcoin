...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-eastnet", "Use the eastnet chain. Equivalent to -chain=eastnet.", ArgsManager::ALLOW_ANY, OptionsCategory::CHAINPARAMS);
...
std::unique_ptr<CBaseChainParams> CreateBaseChainParams(const ChainType chain)
{
    ...
    case ChainType::EASTNET:
        return std::make_unique<CBaseChainParams>("eastnet", 18443, 18445);
    }
    assert(false);
}
